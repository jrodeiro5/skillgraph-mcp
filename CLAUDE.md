...
This project is indexed by GitNexus as **skillgraph-mcp** (1758 symbols, 3372 relationships, 141 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
