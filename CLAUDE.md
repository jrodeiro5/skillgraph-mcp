...
This project is indexed by GitNexus as **skillgraph-mcp** (1589 symbols, 3610 relationships, 110 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
