...
This project is indexed by GitNexus as **skillgraph-mcp** (1049 symbols, 1974 relationships, 68 execution flows). Use the GitNexus MCP tools to understand code, assess impact, and navigate safely.
